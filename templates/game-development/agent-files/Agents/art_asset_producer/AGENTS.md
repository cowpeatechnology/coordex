...
- Template: `{{PROJECT_TEMPLATE_KEY}}/art_asset_producer`
...
- When output formats or import constraints depend on the actual engine or runtime stack, confirm the real project docs before generating files.
