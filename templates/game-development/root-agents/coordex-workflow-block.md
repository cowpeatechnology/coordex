...
- This template assumes a browser-playable game project with visible role coordination. The actual engine, framework, backend, and platform contracts come from the root `AGENTS.md` and durable project docs.
