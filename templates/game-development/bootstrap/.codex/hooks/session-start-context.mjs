...
const main = async () => {
  ...
  parts.push("Browser cleanup rule: close temporary one-off research or inspection tabs after use, while keeping long-lived preview and intentionally reused project tabs open.");
  if (roleKey === "engineer") {
